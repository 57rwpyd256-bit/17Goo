...
<!-- Change this to your hosted G-logo so social previews don't show real photos -->
...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  /* Background: starts empty and shows G logo until user activates image */
      ...
      <div class="content" id="contentArea" aria-hidden="true">
        <div class="main-card" id="mainCard">
          ...
          <div class="msg-card" id="msgCard">
            ...
            <!-- msgText starts empty and hidden; will be filled & revealed only on openMsg -->
